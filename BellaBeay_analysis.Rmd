...
subtitle: "Using Second Source Data to Improve Digital Marketing Strategy"
output:
  html_document:
    df_print: paged
...
**The analysis report and code used here can be found at:**

GitHub Repository: https://github.com/v-Vahe/FItnessTracker_Case_Study
